...
import static com.example.xyzreader.remote.RemoteEndpointUtil.isNetworkAvailable;
...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoordinatorLayout articleListLayout = (CoordinatorLayout)findViewById(R.id.article_list);
        RelativeLayout connectionIssueLayout = (RelativeLayout)findViewById(R.id.connection_issue);
        Button retryButton = (Button)findViewById(R.id.retry_btn);



        if(isNetworkAvailable(this)){
            connectionIssueLayout.setVisibility(View.INVISIBLE);
            articleListLayout.setVisibility(View.VISIBLE);
            ...
            articleListLayout.setVisibility(View.INVISIBLE);
...
//        public ProgressBar imageProgressBar;
        ...
        public ViewHolder(View view) {
            super(view);
//            imageProgressBar = (ProgressBar) view.findViewById(R.id.image_progress_bar);
